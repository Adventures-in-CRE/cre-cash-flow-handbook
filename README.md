...
consumes, what it emits, and how to produce it, in terms a person can read.
Each entry also carries numbered rules precise enough that software can be
built against them without interpretation.
...
Anyone can propose an entry, correct a rule, or file a stub. See
[CONTRIBUTING.md](CONTRIBUTING.md) for the workflow and
[GOVERNANCE.md](GOVERNANCE.md) for how decisions get made.

If you work with an AI assistant, open this repository with it. The skills in
`.claude/skills/` teach it the framework, the entry schema, and the validation
